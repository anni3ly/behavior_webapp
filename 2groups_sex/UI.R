    ...
    dashboardSidebar(
      ...
      fluidRow(
        ...
        selectInput("y", "Y Variable", 
                    choices = c("active", "trial.active", "timeout.active", "inactive","percent.active", "percent.inactive", "reward", "activity"),
                    multiple = FALSE,
                    selected = "active"),
        ...
        mainPanel(
          ...
          tabsetPanel(type = "tabs",
                      ...
                      tabPanel(tags$b("Subjects"), 
                               br(),
                               box(width=12,
                                   title="Individual subjects from THC group",
                                   plotOutput("plot2", height="1000px") %>% withSpinner(color="#0dc5c1")),
                               box(width=12,
                                   title="Individual subjects from VEH group",
                      ...
                      tabPanel(tags$b("Analysis of Variance"),
                               ...
                               box(width=12,
                                   ...
                                   br(),
                                   "Individual subjects nested within treatment by sex (an interaction effect) is annotated as a random effect.",
                                   br(),
                               ...
                               box(width=6,
                                   title="Residuals by Group and Sex",
